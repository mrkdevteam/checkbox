...
4. В "Налаштування платіжної системи" визначте тип (cash або cashless) для кожного способу оплати, який наявний в таблиці.
...
8. В примітках до замовлення з'явиться повідомлення про створення чеку або про помилку.
